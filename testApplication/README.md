...
This is a sample template for testApplication - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name testapplication --tail
```
...
```bash
aws cloudformation delete-stack --stack-name testapplication
```
